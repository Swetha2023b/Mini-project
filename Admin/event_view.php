...
<?php
	...
	$station_delete_query = "DELETE FROM tbl_stud_register WHERE login_id = $login_id" ;
	$checkqueryresult = mysqli_query($db, $station_delete_query);
	$dlt_station = mysqli_fetch_assoc($checkqueryresult);
	if (!$dlt_station){ // if station exists
