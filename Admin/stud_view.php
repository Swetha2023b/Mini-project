...
<!-- <form class="navbar-form navbar-right">
     ...
     <?php
    $query = "SELECT * from tbl_stud_register WHERE status=1";
      ...
      <?php  while ($row = mysqli_fetch_array($result)) {
        ...
        $selectadd=mysqli_query($db, "SELECT stud_housenm, stud_area, stud_city, stud_district, stud_pin, stud_state FROM tbl_stud_address WHERE login_id='$login_id'");
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['stud_father']; ?></td>
                        <td><?php echo $row['stud_mother']; ?></td>
                        <td><?php echo $row['stud_bloodgrp']; ?></td>
                        <td><?php echo $row['stud_item']; ?></td>
                        <td><?php echo $row['stud_size']; ?></td>
                        <td><?php echo $row2['stud_housenm']; ?></td>
                        <td><?php echo $row2['stud_area']; ?></td>
                        <td><?php echo $row2['stud_city']; ?></td>
                        <td><?php echo $row2['stud_district']; ?></td>
                        <td><?php echo $row2['stud_pin']; ?></td>
                        <td><?php echo $row2['stud_state']; ?></td>
                        <td><button class="btn btn-warning"><a href="stud_update.php?id=<?php echo $row['login_id'];?>"style="color:white;">Edit</a></button> </td>
						            <td><button class="btn btn-danger"><a href="stud_delete.php?id=<?php echo $row['login_id'];?>"style="color:white;">Delete</a></button> </td>
                   </tr>  
                  <?php } ?>
                  <?php } ?>
                  <?php } ?>
